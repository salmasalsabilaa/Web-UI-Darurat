...
WebUI.setText(findTestObject('Login/Page_frontend-web/input_Email_input-5667'), '')

WebUI.setText(findTestObject('Login/Page_frontend-web/input_Password_input-5670'), '')
