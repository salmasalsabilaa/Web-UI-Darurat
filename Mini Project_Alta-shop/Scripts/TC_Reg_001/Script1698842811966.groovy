...
WebUI.setText(findTestObject('Register/Page_frontend-web/input_Nama Lengkap_input-5666'), '')

WebUI.setText(findTestObject('Register/Page_frontend-web/input_Email_input-5669'), '')

WebUI.setText(findTestObject('Register/Page_frontend-web/input_Password_input-5672'), '')
